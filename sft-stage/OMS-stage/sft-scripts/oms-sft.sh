...
PROJECT_NAME="3ViewSense-OMS"

MODEL_QWEN3_VL_4B='Qwen/Qwen3-VL-4B-Instruct'
...
DATASET_NAME="3viewsense-oms-sft-data"
...
lf_train_sft "Qwen3-VL-4B-Instruct"   "OMS-Qwen3_VL_4B"    "qwen3_vl_nothink" "$MODEL_QWEN3_VL_4B"
